...
export default () =>
{
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) =>
    {
        ...
        createNotebook.mutate(undefined, {
            onSuccess: ({note_id}) => {
                console.log("created new note book with id:", note_id)
                uploadToFirebase.mutate(note_id)
                router.push(`/notebook/${note_id}`)
            },
            onError: (error) => {
                console.error(`Tough luck: ${error}`)
        ...
        <Dialog>
            ...
            <DialogContent>
                ...
                <form onSubmit={handleSubmit}>
                    <Input value={input} onChange={(e)=>setInput(e.target.value)} type="text" placeholder="Name..."/>
